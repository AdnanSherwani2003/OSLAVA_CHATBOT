...
export class CompleteEventTool implements WriteIntentTool<CompleteEventInput> {
  public readonly name = "complete_event";
  public readonly description =
    "Proposes completing an in-progress event. Requires an explicit operational reason (min 3 chars). Does NOT mutate data immediately; stages a pending action requiring explicit admin confirmation.";
  public readonly inputSchema = completeEventInputSchema;
